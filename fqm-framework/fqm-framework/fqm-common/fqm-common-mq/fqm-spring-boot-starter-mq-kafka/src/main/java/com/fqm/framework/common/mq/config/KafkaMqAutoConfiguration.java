...
import com.fqm.framework.common.mq.listener.KafkaMqListener;
import com.fqm.framework.common.mq.listener.MqListenerParam;
import com.fqm.framework.common.mq.template.KafkaMqTemplate;
        ...
        for (MqListenerParam v : mq.getListeners()) {
            ...
            if (applicationContext.containsBean(name) == false) {
                ...
                if (MqMode.kafka.name().equals(v.getBinder())) {
                    ...
                    ContainerProperties containerProperties = new ContainerProperties(v.getDestination());
