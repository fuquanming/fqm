...
import com.fqm.framework.common.mq.listener.RocketMqListener;
import com.fqm.framework.common.mq.template.RocketMqTemplate;
        ...
        for (MqListenerParam v : mq.getListeners()) {
            ...
            if (applicationContext.containsBean(name) == false) {
                ...
                if (MqMode.rocket.name().equals(v.getBinder())) {
                    ...
                    beanDefinitionBuilder.addPropertyValue("topic", v.getDestination());
                    ...
                    beanDefinitionBuilder.addPropertyValue("rocketMQMessageListener", 
                            rocketMQMessageListener(nameServer, v.getDestination(), v.getGroup(), v.getConcurrentConsumers()));
