...
public class RedissonMqController extends BaseController {
    ...
    public static final String TOPIC_1 = "redisson-topic1";
    /** 死信主题名称：对应配置文件 mq.mqs.xxx，死信主题：topic + ".DLQ" */
    public static final String TOPIC_DEAD = "redisson-topic.DLQ";
    public static final String TOPIC_1_DEAD = "redisson-topic1.DLQ";
    @Resource
