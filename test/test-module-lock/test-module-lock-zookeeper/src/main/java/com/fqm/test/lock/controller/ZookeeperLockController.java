...
public class ZookeeperLockController {
    ...
    public static final String BUSINESS_NAME = "zookeeper";
    public static final String BUSINESS_NAME_1 = "zookeeper1";
...
class ZookeeperLockUserService {
    private Logger logger = LoggerFactory.getLogger(getClass());
    @Lock4j(name = ZookeeperLockController.BUSINESS_NAME)
    public Object getUserByLock4jLock() {
        logger.info("Thread:{},ZookeeperLockUserService", Thread.currentThread().getName());
    ...
    @Lock4j(name = ZookeeperLockController.BUSINESS_NAME_1)
    public Object getUserByLock4jLock2() {
        logger.info("Thread2:{},ZookeeperLockUserService2", Thread.currentThread().getName());
        HashMap<String, Object> user = new HashMap<>();
        try {
            TimeUnit.SECONDS.sleep(2);
        } catch (InterruptedException e) {
